...
if(isset($_POST["submit"])){ 
  ...
  $movieID = $_POST["hidden_movieID"];
	...
	$dbStmt=$database->prepare("INSERT INTO ReviewTable (userID, movieID, reviewRating, reviewText, checked) 
	VALUES (:userID, :movieID, :reviewRating, :reviewText, :checked)"); //reviewID would be PK autoincrement
	$r = $stmt -> execute ([
		":userID"=>$userID,
		":movieID"=>$movieID,
...
<body>
  ...
  <div class="container" style="width:700px;">  
    ...
    ?> 
    <div class="col-md-4">  
        <form method="post" action="movie.php?id=<?php echo $row["movieID"]; ?>">  
